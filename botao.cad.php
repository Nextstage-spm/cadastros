...
<div class="button-container">
    <a href="#" data-url="3.php" class="carregar-conteudo button btn-orange-light-top">Funcionário<i class="fas fa-hard-hat"></i></a>
    <a href="#" data-url="curso1.php" class="carregar-conteudo button btn-purple-light-top">Curso<i class="fas fa-book-open"></i></a>
    <a href="#" data-url="prof1.php" class="carregar-conteudo button btn-green-light-top">Professor<i class="fas fa-chalkboard-teacher"></i></a>
    <a href="#" data-url="turma2.php" class="carregar-conteudo button btn-red-light-top">Turma<i class="fas fa-users"></i></a>
    <a href="#" data-url="cad.dic.php" class="carregar-conteudo button btn-orange-light-bottom">Disciplina<i class="fas fa-book"></i></a>
    <a href="#" data-url="3.2.php" class="carregar-conteudo button btn-purple-light-bottom">Aluno<i class="fas fa-user-graduate"></i></a>
    <a href="#" data-url="int.php" class="carregar-conteudo button btn-green-light-bottom">Instituição<i class="fas fa-university"></i></a>
</div>
