...
<div class="form-group">
    ...
    <div class="container" id="form2">
        ...
        <fieldset id="fieldset_3">
            ...
            <div class="form-group">
                <label>
                    <input type="checkbox" id="precisa_responsavel" name="" onclick="toggleResponsavelSection()">
                    <label for="precisa-responsavel">Você tem menos de 18 anos e precisa de um responsável?</label>
            </div>
