...
<head>
    ...
    margin: 10px auto;
    padding: 12px;
    width: 50%; /* Reduza a largura conforme necessário */
    border-radius: 15px;
    border: 1px solid #5aa2b0;
    font-size: 12px;
    text-align: left;
...
<body>
    ...
    <div class="container">
        ...
        <div><form method="POST" action=""></div>
            <input type="text" id="searchInput" name="search" placeholder="Pesquisar por nome..." value="<?php echo htmlspecialchars($searchTerm); ?>">
