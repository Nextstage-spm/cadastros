...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['nome']) && !empty($_POST['nome']) && isset($_POST['titulacao_cod']) && !empty($_POST['titulacao_cod'])) {
        ...
        $titulacao_cod = $_POST['titulacao_cod']; // Alterado para titulacao_cod

        try {
            // Prepara a query para inserir os dados na tabela 'professor'
            $query = $conn->prepare("INSERT INTO professor (nome, titulacao_cod) VALUES (:nome, :titulacao_cod)"); // Alterado para titulacao_cod
            
            // Faz o bind dos parâmetros
            $query->bindParam(':nome', $nome_professor);
            $query->bindParam(':titulacao_cod', $titulacao_cod); // Alterado para titulacao_cod
