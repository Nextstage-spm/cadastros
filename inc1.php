        ...
        <form id="formInscricao" action="inscricao.php" method="POST">
            ...
            <div class="form-section active" id="section1">
               ...
               <h2><label for="unidade-de-ensino">Unidade de Ensino</label></h2>
                <input type="text" id="unidade-de-ensino" name="unidade-de-ensino" placeholder="Unidade de Ensino" value="<?php echo htmlspecialchars($aluno['unidade_ensino']); ?>" readonly>
</div>
...
<div>
        ...
        <fieldset>
            ...
            <input type="tel" id="telefone" name="telefone" placeholder="(00) 0000-0000"  value="<?php echo htmlspecialchars($aluno['telefone']); ?>" readonly disabled>
...
<br>
    ...
    <br>
            ...
            <div class="form-section" id="section3">
                ...
                <input type="text" id="cpf" name="cpf" placeholder="CPF do Aluno"  value="<?php echo htmlspecialchars($aluno['cpf']); ?>" readonly disabled>
