...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['nome']) && !empty($_POST['nome']) && isset($_POST['cursos']) && !empty($_POST['cursos'])) {
        ...
        try {
            ...
            $query = $conn->prepare("INSERT INTO turma (nome, cursos_id ) VALUES (:nome, cursos_id)");

            // Faz o bind dos parâmetros
            $query->bindParam(':nome', $nome);
            $query->bindParam(':cursos_id', $cursos_id);
...
<form method="post" action="">
    ...
    <input type="text" name="perido" id="periodo" required>
