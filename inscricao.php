...
/* Cores diferentes para cada link do menu */
.menu a.inicio::after {
    color: #011772; 
}
...
.menu a.consulta::after {
    color: #1e90ff; /* Azul Dodger */
}

.menu a.duvidas::after {
...
.round-button {
        ...
        .required::after {
            content: " *"; /* Insere o asterisco após o texto */
    ...
    <div class="header-container"></div>
        ...
        <form id="formInscricao" action="inscricao.php" method="POST">
            ...
            <div class="form-section active" id="section1">
               <h2><label for="unidade_de_ensino">Unidade de Ensino</label></h2>
                <input type="text" id="unidade_de_ensino" name="unidade_de_ensino" placeholder="Unidade de Ensino">
                ...
                <label for="serie_semestre">Série/Semestre</label>
                <br>
                <input type="text" id="serie_semestre" name="serie_semestre" placeholder="Série/Semestre">
